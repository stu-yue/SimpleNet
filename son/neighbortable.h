/**
 * @file    son/neighbortable.h
 * @brief   这个文件定义邻居表的数据结构和API
 * @date    2023-02-23
 */
...
/**
 * @brief   这个函数首先动态创建一个邻居表. 
 *          然后解析文件topology/topology.dat, 
 *          填充所有条目中的nodeID和nodeIP字段, 
 *          将conn字段初始化为-1, 返回创建的邻居表.
 * 
 * @return nbr_entry_t* 
 */
...
/**
 * @brief   这个函数为邻居表中指定的邻居节点条目分配一个TCP连接. 
 *          如果分配成功, 返回1, 否则返回-1.
 * 
 * @param nt 
 * @param nodeID 
